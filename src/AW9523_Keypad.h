...
class AW9523_Keypad : public AW9523_Key {
public:

	AW9523_Keypad(Adafruit_AW9523 *aw,char *userKeymap, byte *row, byte *col, byte numRows, byte numCols);
